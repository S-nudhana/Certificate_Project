...
//         const excel = excelQuery[0][0].event_excel;
//         console.log(excel)
//         if (!excel) {
...
//         const studentData = columnAData.map((name, index) => [
//             columnAData[index],
//             columnBData[index],
//             eventId,
//             0,
...
//             "INSERT INTO student (student_email, student_password, student_joinEventId, student_eventGenerated) VALUES ?", [studentData]
//         );
//         await db
//             .promise()
