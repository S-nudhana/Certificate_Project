...
export default function StatisticChart({participantsAmount, participantsDownloadAmount, eventName}) {
    return (
        <Flex width={"100%"} justifyContent={"center"} pt={"20px"} flexDir={"column"}>
            <Text align={"center"} fontSize={"24px"} fontWeight="bold" textDecor={"underline"} pb={"20px"}>สถิติของกิจกรรม {eventName}</Text>
            <Box
            ...
            >
                ...
                />
                <Box pt={{ base: "20px", lg: "0" }} alignContent={"center"} fontSize={{base:"14px", md:"16px"}}>
